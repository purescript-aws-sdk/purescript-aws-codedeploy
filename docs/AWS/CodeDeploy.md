...
``` purescript
addTagsToOnPremisesInstances :: forall eff. AddTagsToOnPremisesInstancesInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
continueDeployment :: forall eff. ContinueDeploymentInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteApplication :: forall eff. DeleteApplicationInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteDeploymentConfig :: forall eff. DeleteDeploymentConfigInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deregisterOnPremisesInstance :: forall eff. DeregisterOnPremisesInstanceInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
registerApplicationRevision :: forall eff. RegisterApplicationRevisionInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
registerOnPremisesInstance :: forall eff. RegisterOnPremisesInstanceInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
removeTagsFromOnPremisesInstances :: forall eff. RemoveTagsFromOnPremisesInstancesInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
skipWaitTimeForInstanceTermination :: forall eff. SkipWaitTimeForInstanceTerminationInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
updateApplication :: forall eff. UpdateApplicationInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
